    ...
    if file_names:
        ...
        if files:
            ...
            for run_id, n_clusters_perc in enumerate(n_clusters_percs):
                ...
                response, validation_response = build_response(projects, clusters, tokens_similarity,\
                                                               names_col, ids_col)
                ...
                # Results
                results_row = [run_id, file_names, project, customer, num_files, run_start, run_end, run_duration, tasks_count, \
                               language_model, model_name, clustering_params_write, \
                               n_clusters_perc, n_clusters, ave_std, mean_tpc, median_tpc, min_tpc, max_tpc, min_max_tpc,\
                               wcss, bcss, ch_index, db_index, silhouette]
            ...
            response = responses[best_score_run_id]
