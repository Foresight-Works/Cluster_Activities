...
'''
test download
s3.Bucket(ds_bucket).download_file('treatments/T201008CHEM_SUBS.CSV', './T201008CHEM_SUBS.CSV')
'''
...
for source_file in source_files:
    ...
    s3.Bucket(ds_bucket).download_file('sources/{fn}'.format(fn=source_file),zip_file_save_path)
