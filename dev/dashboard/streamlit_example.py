...
st.subheader("Here's our first attempt at using response to create a table:")
...
st.subheader("Let’s use Numpy to generate some sample response and plot it on a map of San Francisco:")
...
st.subheader("Use checkboxes to show/hide response")
